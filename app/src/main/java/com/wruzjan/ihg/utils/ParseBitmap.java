...
public class ParseBitmap {
    ...
    public ParseBitmap(Bitmap _bmp){
        try{
            ...
            Log.d(Utils.DEBUG_TAG, e.getMessage());
        }
    }

    public String ExtractGraphicsDataForCPCL(int _xpos,int _ypos){
        m_data = "";
        StringBuilder strBuilder = new StringBuilder(m_data);
        ...
        try{
            ...
            strBuilder.append("EG ");
            strBuilder.append(Integer.toString((loopWidth / 8)));
            strBuilder.append(" ");
            strBuilder.append(Integer.toString(m_bmp.getHeight()));
            strBuilder.append(" ");
            strBuilder.append(Integer.toString(_xpos));
            strBuilder.append(" ");
            strBuilder.append(Integer.toString(_ypos));
            strBuilder.append(" ");
//            m_data = "EG" + " " +
...
//                        m_data = m_data + hex.toUpperCase();
            ...
            strBuilder.append("\r\n");
            m_data = strBuilder.toString();

        }catch(Exception e){
            m_data = e.getMessage();
            Log.d(Utils.DEBUG_TAG, "EXCEPTION: " + e.getMessage());
            return m_data;
        }
