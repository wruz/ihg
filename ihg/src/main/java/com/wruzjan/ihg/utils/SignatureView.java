...
public class SignatureView extends View {
    ...
    private ParseBitmap bitmapParser;
    ...
    public String capture(){
        View mView = findViewById(R.id.captureSignatureView);
    ...
    private void save(View v)
    {
        ...
        try
        {
            FileOutputStream mFileOutStream = new FileOutputStream(Utils.SIGNATURE_PATH);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            default:
                Log.d("IHG_DEBUG", "Ignored touch event: " + event.toString());
                return false;
        }
