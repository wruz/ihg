...
public class GeneratePDFNewPaderewskiego {
...
//        }
        ...
        form.setField("toilet_clean", protocol.get_toilet_clean());
        form.setField("flue_clean", protocol.get_flue_clean());
    ...
    public String generatePdf(Address address, ProtocolNewPaderewskiego protocol, boolean forceSave) throws Exception {
