...
public class ProtocolNewPaderewskiego {
    ...
    //default value: tak
    private String _kitchen_clean = "";
    //default value: tak
    private String _bath_clean = "";
    //empty default value
    private String _toilet_clean = "";
    //default value: nie
    private String _flue_clean = "";
...
//    used for tracking changes
    ...
    public ProtocolNewPaderewskiego(float _co2, int _version, float _temp_outside, float _temp_inside,
                                    boolean _kitchen_enabled, float _kitchen_grid_dimension_x,
                                    float _kitchen_grid_dimension_y, float _kitchen_airflow_windows_closed,
                                    float _kitchen_airflow_microventilation, String _kitchen_comments,
                                    boolean _bathroom_enabled, float _bathroom_grid_dimension_x,
                                    float _bathroom_grid_dimension_y, float _bathroom_airflow_windows_closed,
                                    float _bathroom_airflow_microventilation, String _bathroom_comments,
                                    boolean _toilet_enabled, float _toilet_grid_dimension_x,
                                    float _toilet_grid_dimension_y, float _toilet_airflow_windows_closed,
                                    float _toilet_airflow_microventilation, String _toilet_comments,
                                    boolean _flue_enabled, float _flue_airflow_windows_closed,
                                    float _flue_airflow_microventilation, String _flue_comments,
                                    boolean _gas_fittings_working, boolean _gas_cooker_working,
                                    boolean _bathroom_bake_working, String _gas_fittings_comments,
                                    String _equipment_comments, String _comments_for_user,
                                    String _comments_for_manager, String _telephone) {
        this._co2 = _co2;
    ...
    public ProtocolNewPaderewskiego(int _id, int _address_id, int _worker_id, float _co2, int _version,
                                    float _temp_outside, float _temp_inside, boolean _kitchen_enabled,
                                    float _kitchen_grid_dimension_x, float _kitchen_grid_dimension_y,
                                    float _kitchen_airflow_windows_closed, float _kitchen_airflow_microventilation,
                                    String _kitchen_comments, boolean _bathroom_enabled, float _bathroom_grid_dimension_x,
                                    float _bathroom_grid_dimension_y, float _bathroom_airflow_windows_closed,
                                    float _bathroom_airflow_microventilation, String _bathroom_comments,
                                    boolean _toilet_enabled, float _toilet_grid_dimension_x, float _toilet_grid_dimension_y,
                                    float _toilet_airflow_windows_closed, float _toilet_airflow_microventilation,
                                    String _toilet_comments, boolean _flue_enabled, float _flue_airflow_windows_closed,
                                    float _flue_airflow_microventilation, String _flue_comments, boolean _gas_fittings_working,
                                    boolean _gas_cooker_working, boolean _bathroom_bake_working,
                                    String _gas_fittings_comments, String _equipment_comments, String _comments_for_user,
                                    String _comments_for_manager, String _telephone) {
        this._id = _id;
    ...
    public String get_kitchen_clean() {
        return _kitchen_clean;
    }

    public void set_kitchen_clean(String _kitchen_clean) {
        this._kitchen_clean = _kitchen_clean;
    }

    public String get_bath_clean() {
        return _bath_clean;
    }

    public void set_bath_clean(String _bath_clean) {
        this._bath_clean = _bath_clean;
    }

    public String get_toilet_clean() {
        return _toilet_clean;
    }

    public void set_toilet_clean(String _toilet_clean) {
        this._toilet_clean = _toilet_clean;
    }

    public String get_flue_clean() {
        return _flue_clean;
    }
